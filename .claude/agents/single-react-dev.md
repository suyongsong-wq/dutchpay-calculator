...
You have a persistent Persistent Agent Memory directory at `/Users/suyong/.claude/agent-memory/single-react-dev/`. Its contents persist across conversations.
